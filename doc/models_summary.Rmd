...
```{r tot }
res %>%
  filter(endsWith(source, "totfixdur_full_models.csv")) %>%
  select(-source, -quant) %>%
  kable()
```
...
```{r tot2 }
res %>%
  filter(endsWith(source, "totfixdur_split_models.csv")) %>%
  select(-source) %>%
  kable()
```
...
```{r rrdur }
res %>%
  filter(endsWith(source, "rrdur_full_models.csv")) %>%
  select(-source, -quant) %>%
  kable()
```
...
```{r rrdur2 }
res %>%
  filter(endsWith(source, "rrdur_split_models.csv")) %>%
  select(-source) %>%
  kable()
```
...
```{r rpdur }
res %>%
  filter(endsWith(source, "rpdur_full_models.csv")) %>%
  select(-source, -quant) %>%
  kable()
```
...
```{r rpdur2 }
res %>%
  filter(endsWith(source, "rpdur_split_models.csv")) %>%
  select(-source) %>%
  kable()
```
...
```{r gdur }
res %>%
  filter(endsWith(source, "gdur_full_models.csv")) %>%
  select(-source, -quant) %>%
  kable()
```
...
```{r gdur2 }
res %>%
  filter(endsWith(source, "gdur_split_models.csv")) %>%
  select(-source) %>%
  kable()
```
...
```{r tgdur }
res %>%
  filter(endsWith(source, "tgdur_full_models.csv")) %>%
  select(-source, -quant) %>%
  kable()
```
...
```{r tgdur2 }
res %>%
  filter(endsWith(source, "tgdur_split_models.csv")) %>%
  select(-source) %>%
  kable()
```
